...
#print('Jack's favorite food is burger')   # syntax error
print("Jack's favorite food is burger")

#print("많이 생각하는 모든 것들은 문제가 된다." - "프레드리히 니체") # syntax error
print(' "많이 생각하는 모든 것들은 문제가 된다." - "프레드리히 니체" ')

# 특별한 의미를 가진 이스케이프 코드 : 미리 정의해둔 문자 조합
# \n : 개행(줄바꿈), \t : tab, \\ : \ 출력, \b : 백스페이스
...
print('------------------------------------------------')
# 문자열 연산 - 사람(개발자) 생각을 그대로 반영해주는 파이선의 장점
